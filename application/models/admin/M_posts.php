...
class M_posts extends CI_Model {
  ...
  var $table          = "psr_posts";
  var $column_order   = array(null,'post_title','post_category','display_name','post_view_count','post_date');
  var $column_search  = array('post_title','display_name','post_view_count','post_date');
  var $order          = array('post_date'=>'desc');
  ...
  private function _get_datatables_query()
  {
      ...
      {
          $this->db->like('post_category',$this->session->userdata('post_category'));
      }
