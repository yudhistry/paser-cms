<div class="row">
  <div class="col-md-12">
    <section class="card mb-4">
      <?php echo form_open_multipart('admin/link/update/'.$this->uri->segment(5),array('class'=>'form-horizontal'));?>
      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          echo form_input('link_title',set_value('link_title',$data->link_title),'class="form-control"');
        ...
        <div class="form-group row">
          ...
          echo '<div class="col-md-6">';
          echo form_input('link_url',set_value('link_url',$data->link_url),'class="form-control"');
        ...
        <div class="form-group row">
          ...
          elseif($data->link_img_path)
          {
            $image_properties = array(
              'src' => $data->link_img_path,
              'class' => 'center',
              'height' => '100'
            );
            $image = img($image_properties);
            echo form_hidden('link_img_path',$data->link_img_path);
            echo form_button(array('type'=>'submit','class'=>'btn btn-transparent','name'=>'btn_link_img_path','content'=>$image));
          }
          else
          {
