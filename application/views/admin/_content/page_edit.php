<div class="row">
  <div class="col-md-12">
    <section class="card mb-4">
      <?php echo form_open('admin/page/update/'.$this->uri->segment(4));?>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-9">
            ...
            <div class="form-group">
              <textarea name="post_content" class="summernote col-lg-12" data-plugin-summernote data-plugin-options='{ "height": 335, "codemirror": { "theme": "ambiance" } }'>
                <?php
                $post_content = $this->input->post('post_content') ? $this->input->post('post_content') : $data->post_content;
                echo set_value('post_content',$post_content);
                ?>
              </textarea>
            </div>
          </div>
          <div class="col-md-3">
            ...
            <div class="form-group">
              <div class="btn-group d-flex">
                ...
                echo anchor('pasery/page','<i class="fas fa-times"></i> Batal',array('class'=>'btn btn-default'));
                ?>
              </div>
            </div>
