<div class="row">
  <div class="col-md-12">
    <section class="card mb-4">
      <?php echo form_open_multipart('admin/document/insert/'.$this->uri->segment(4));?>
      <header class="card-header">
        <div class="card-actions">
          <a href="<?php echo site_url('pasery/document/'.$this->uri->segment(4));?>" class="card-action" title="Tutup"><i class="fas fa-chevron-left"></i></a>
        </div>
        <h2 class="card-title">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          echo form_input('doc_title',set_value('doc_title'),'class="form-control"');
        ...
        <div class="form-group row">
          ...
          echo '<div class="col-md-10">';
          echo form_textarea(array('name'=>'doc_description','value'=>set_value('doc_description'),'class'=>'form-control','rows'=>'4'));
        ...
        <div class="form-group row">
          ...
          echo '<div class="col-md-10">';
          $datepick = $this->input->post('doc_endorsement') ? $this->input->post('doc_endorsement') : date('d/m/Y');
          ?>
      ...
      <div class="card-footer">
        <div class="form-group row">
          ...
          echo form_button(array('type'=>'submit','name'=>'btn_save_doc','content'=>'<i class="fas fa-save"></i> Tambahkan '.$page,'class'=>'btn btn-sm btn-primary'));
          echo anchor('pasery/document/'.$this->uri->segment(4),'<i class="fas fa-times"></i> Batal',array('class'=>'btn btn-sm btn-default'));
          echo '</div>';
          ?>
        </div>
      </div>
