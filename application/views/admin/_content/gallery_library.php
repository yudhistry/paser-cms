    ...
    <section class="card mb-4">
      <header class="card-header">
        <div class="card-actions">
          <a href="<?php echo site_url('pasery/gallery/edit/'.$this->uri->segment(4));?>" class="card-action"><i class="fas fa-times"></i></a>
        </div>
        <h2 class="card-title">Tambah Gambar</h2>
        <p class="card-subtitle"><?php echo $data->gal_title;?></p>
      </header>
      <div class="card-body">
        <div class="row">
          <div class="col-md-4">
            ...
            <div id="modalAdd" class="modal-block modal-block-primary mfp-hide">
              <section class="card">
                ...
                echo form_hidden('redirect','pasery/gallery/library/'.$this->uri->segment(4));
                ?>
                <header class="card-header">
        ...
        <?php echo form_open_multipart('admin/gallery/update/'.$this->uri->segment(4),array('class'=>'form-horizontal'));?>
