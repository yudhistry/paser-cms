    ...
    <section class="card mb-4">
      <header class="card-header">
        <div class="card-actions">
          <a href="<?php echo site_url('pasery/post/edit/'.$this->uri->segment(4));?>" class="card-action"><i class="fas fa-times"></i></a>
        </div>
      ...
      <div class="card-body">
          ...
          <div class="col-md-4">
            ...
            <div id="modalAdd" class="modal-block modal-block-primary mfp-hide">
              <section class="card">
                ...
                echo form_hidden('redirect','pasery/post/edit/'.$this->uri->segment(4));
                ?>
                <header class="card-header">
        ...
        <?php
        echo form_open_multipart('pasery/post/edit/'.$this->uri->segment(4),array('class'=>'form-horizontal'));
        ...
        echo form_hidden('post_headline',$this->input->post('post_headline'));
        //echo form_hidden('post_order',$this->input->post('post_order'));
        if($this->input->post('post_category'))
        {
          foreach($this->input->post('post_category') as $key=>$value)
          {
            echo form_hidden('post_category['.$value.']',$value);
          }
        }
        ?>
