    ...
    <section class="card mb-4">
      <header class="card-header">
        <div class="card-actions">
          <a href="<?php echo site_url('pasery/page/add');?>" class="card-action"><i class="fas fa-times"></i></a>
        </div>
      ...
      <div class="card-body">
          ...
          <div class="col-md-4">
            ...
            <div id="modalAdd" class="modal-block modal-block-primary mfp-hide">
              <section class="card">
                ...
                echo form_hidden('redirect','pasery/page/add');
                ?>
                <header class="card-header">
        ...
        <?php
        echo form_open_multipart('pasery/page/add',array('class'=>'form-horizontal'));
