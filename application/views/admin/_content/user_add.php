    ...
    <section class="card mb-4">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          echo form_input('user_login',set_value('user_login'),array('class'=>'form-control'));
        ...
        <div class="form-group row">
          ...
          echo '<div class="col-md-6">';
          echo form_input('user_fullname',set_value('user_fullname'),array('class'=>'form-control'));
        ...
        <div class="form-group row">
          ...
          echo '<div class="col-md-6">';
          echo form_input('user_email',set_value('user_email'),array('class'=>'form-control'));
        ...
        <div class="form-group row">
          ...
          echo '<div class="col-md-6">';
          echo form_input('user_url',set_value('user_url'),array('class'=>'form-control'));
        ...
        <div class="form-group row">
          ...
          echo '<div class="col-md-6">';
          echo form_input('user_phone',set_value('user_phone'),array('class'=>'form-control'));
          echo '</div>';
          ?>
        </div>
        ...
        <div class="form-group row">
          ...
          echo form_dropdown('user_role',$role,'2',array('class'=>'form-control'));
          echo '</div>';
          ?>
        </div>
        <div class="form-group row">
