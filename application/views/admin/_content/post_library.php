    ...
    <section class="card mb-4">
      <header class="card-header">
        <div class="card-actions">
          <a href="<?php echo site_url('pasery/post/add');?>" class="card-action"><i class="fas fa-times"></i></a>
        </div>
        <h2 class="card-title">Tambah <?php echo $page;?></h2>
      </header>
      <div class="card-body">
        <div class="row">
          <div class="col-md-4">
            ...
            <div id="modalAdd" class="modal-block modal-block-primary mfp-hide">
              <section class="card">
                ...
                echo form_hidden('redirect','pasery/post/add');
                ?>
                <header class="card-header">
        ...
        <?php
        echo form_open_multipart('pasery/post/add',array('class'=>'form-horizontal'));
