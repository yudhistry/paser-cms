          ...
          <div class="col-sm-4">
            ...
            echo form_open('public/document/search');
              echo '<div class="input-group">';
  							echo '<input class="form-control form-control-sm text-1" placeholder="Pencarian..." name="search" value="'.set_value('search').'" id="s" type="text">';
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr class="text-center">
                  <th width="50px"><i class="fas fa-search"></i></th>
                  <th>Nama</th>
              ...
              <tbody>
                ...
                foreach($dokumen as $row)
                {
                  ...
                  {
                    $iconx = '<i class="fas fa-folder text-warning"></i>';
                  }
                  else {
                  ...
                  echo '<tr>';
                    echo '<td class="text-right">'.$iconx.'</td>';
                    echo '<td>'.$anchor.'</td>';
